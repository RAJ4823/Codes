 ...
 *  RUNTIME: 81 ms
 *  MEMORY: 13.5 MB
 *  DATE: 12-30-2022, 7:09:57 PM
 *
 */

// Solution:

#define min_priority_queue priority_queue<pair<int,int>, vector<pair<int,int>>, greater<>>

class Solution {
private:
    vector<int> dijkstra(int source, vector<pair<int,int>> adj[], int n, min_priority_queue &pq) {
