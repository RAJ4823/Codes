...
class Solution {
public:
    vector<int> topo_sort(vector<vector<int>> &adj, vector<int> &deg, int size) {
        vector<int> sorted;
        queue<int> q;
    ...
    vector<int> sortItems(int n, int m, vector<int>& group, vector<vector<int>>& beforeItems) {
        ...
        vector<int> sorted_group = topo_sort(adj_group, deg_group, m);
        vector<int> sorted_item = topo_sort(adj_item, deg_item, n);
